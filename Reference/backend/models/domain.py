...
import sys
for _name in ['backend.main','backend.api.products','backend.api.customers','backend.api.inventory','backend.api.carts','backend.api.checkout','backend.api.orders','backend.api.payments','backend.api.refunds','backend.api.invoices','backend.services.pricing_service','backend.services.order_service','backend.services.inventory_service','backend.services.discount_service','backend.services.tax_service','backend.services.shipping_service','backend.services.payment_service','backend.services.invoice_service','backend.repositories.product_repository']:
